...
export const validationSchema = Yup.object({
    name: Yup.string().required('Title is a required field').optional(),
    email: Yup.string().email('Invalid email address').required('Email is a required field').optional(),
    website: Yup.string().url('Please enter a valid URL').optional(),
    phone: Yup.string().required('Phone is a required field').optional(),
    industry: Yup.string().required('Industry is a required field').optional(),
